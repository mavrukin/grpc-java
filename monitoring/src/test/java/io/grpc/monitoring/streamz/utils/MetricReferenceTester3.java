...
public class MetricReferenceTester3<F1, F2, F3, V>
     extends MetricReferenceTester<V> {

  MetricReferenceTester3(StreamzTester tester, String metricName,
      Class<V> valueType,
      Field<F1> field1,
      Field<F2> field2,
      Field<F3> field3) {
  ...
  MetricReferenceTester3(StreamzTester tester, String metricName, Class<V> valueType,
      String... fieldNames) {
