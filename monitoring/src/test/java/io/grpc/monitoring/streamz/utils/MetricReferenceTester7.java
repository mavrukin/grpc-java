...
public class MetricReferenceTester7<F1, F2, F3, F4, F5, F6, F7, V>
     extends MetricReferenceTester<V> {

  MetricReferenceTester7(StreamzTester tester, String metricName,
      Class<V> valueType,
      Field<F1> field1,
      Field<F2> field2,
      Field<F3> field3,
  ...
  MetricReferenceTester7(StreamzTester tester, String metricName, Class<V> valueType,
      String... fieldNames) {
