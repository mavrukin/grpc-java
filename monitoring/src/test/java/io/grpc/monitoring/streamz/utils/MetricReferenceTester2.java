...
/**
 * Reference to an two-dimensional Metric. Used for testing.
 *
...
public class MetricReferenceTester2<F1, F2, V>
     extends MetricReferenceTester<V> {

  MetricReferenceTester2(StreamzTester tester, String metricName,
      Class<V> valueType,
      Field<F1> field1,
      Field<F2> field2) {
  ...
  MetricReferenceTester2(StreamzTester tester, String metricName, Class<V> valueType,
      String... fieldNames) {
