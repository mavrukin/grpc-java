...
/**
 * A ten-dimensional Metric. This provides access to {@link StoredCell}s,
...
public class Metric10<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, V>
    extends StoredMetric<V, Metric10<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, V>> {

  /**
   * @see #createCellKey(
   *      Object, Object, Object, Object, Object, Object, Object, Object, Object, Object)
   */
  public static final class CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> extends FieldTuple {
    CellKey(F1 field1,
      F2 field2,
      F3 field3,
      F4 field4,
   ...
   */
  public static
      <F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>
      createCellKey(
          F1 field1,
      F2 field2,
      F3 field3,
      ...
      F9 field9,
      F10 field10) {
    return new CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>(
        field1, field2, field3, field4, field5, field6, field7, field8, field9, field10);
  }

  Metric10(String name, ValueTypeTraits<V> traits, Metadata metadata,
   ...
   */
  public void set(
      CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key,
      V value) {
    super.set(key, value);
  }
   ...
   */
  public V get(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key) {
   ...
   */
  public void clear(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key) {
    super.clear(key);
  }
   ...
   */
  public void increment(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key) {
    super.increment(key);
  }
   ...
   */
  public void decrement(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key) {
    super.decrement(key);
  }
  ...
  public void incrementBy(
      CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10> key, Number value) {
  ...
  @Override
  public Set<CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>> keySet() {
    return (Set<CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>>) super.keySet();
  }
}