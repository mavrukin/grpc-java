...
/**
 * A nine-dimensional Metric. This provides access to {@link StoredCell}s,
...
public class Metric9<F1, F2, F3, F4, F5, F6, F7, F8, F9, V>
    extends StoredMetric<V, Metric9<F1, F2, F3, F4, F5, F6, F7, F8, F9, V>> {

  /**
   * @see #createCellKey(
   *      Object, Object, Object, Object, Object, Object, Object, Object, Object)
   */
  public static final class CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> extends FieldTuple {
    CellKey(F1 field1,
      F2 field2,
      F3 field3,
      F4 field4,
   ...
   */
  public static
      <F1, F2, F3, F4, F5, F6, F7, F8, F9> CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9>
      createCellKey(
          F1 field1,
      F2 field2,
      F3 field3,
      ...
      F8 field8,
      F9 field9) {
    return new CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9>(
        field1, field2, field3, field4, field5, field6, field7, field8, field9);
  }

  Metric9(String name, ValueTypeTraits<V> traits, Metadata metadata,
   ...
   */
  public void set(
      CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key,
      V value) {
    super.set(key, value);
  }
   ...
   */
  public V get(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key) {
   ...
   */
  public void clear(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key) {
    super.clear(key);
  }
   ...
   */
  public void increment(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key) {
    super.increment(key);
  }
   ...
   */
  public void decrement(CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key) {
    super.decrement(key);
  }
  ...
  public void incrementBy(
      CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9> key, Number value) {
  ...
  @Override
  public Set<CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9>> keySet() {
    return (Set<CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9>>) super.keySet();
  }
}