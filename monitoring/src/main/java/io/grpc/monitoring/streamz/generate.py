...
def _GenerateFiles(this_dir, max_metric_dimension):
  ...
  tester_factory_methods_templates = open(os.path.join(this_dir,
       '../../../../../../test/java/io/grpc/monitoring/streamz/utils/StreamzTester.factoryMethods.java.template'),
                                          'r').read()
   ...
   * @param field%dName The name of field%d""" % (i, i)
    ...
    _WriteFile(this_dir, 'utils/MetricReference.java.template',
               'utils/MetricReference%d.java' % dimensionality, template_vars)
    _WriteFile(this_dir, '../../../../../../test/java/io/grpc/monitoring/streamz/utils/MetricReferenceTester.java.template',
               '../../../../../../test/java/io/grpc/monitoring/streamz/utils/MetricReferenceTester%d.java' % dimensionality, template_vars)
  ...
  _WriteFile(this_dir, '../../../../../../test/java/io/grpc/monitoring/streamz/utils/StreamzTester.java.template',
             '../../../../../../test/java/io/grpc/monitoring/streamz/utils/StreamzTester.java', template_vars)
