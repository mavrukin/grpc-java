...
/**
 * A seven-dimensional CallbackMetric.
 *
...
public class CallbackMetric7<F1, F2, F3, F4, F5, F6, F7, V>
    extends CallbackMetric<V, CallbackMetric7<F1, F2, F3, F4, F5, F6, F7, V>> {

  CallbackMetric7(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric7.CellKey<F1, F2, F3, F4, F5, F6, F7>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric7.CellKey<F1, F2, F3, F4, F5, F6, F7>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric7.CellKey<F1, F2, F3, F4, F5, F6, F7>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
