...
/**
 * A four-dimensional CallbackMetric.
 *
...
public class CallbackMetric4<F1, F2, F3, F4, V>
    extends CallbackMetric<V, CallbackMetric4<F1, F2, F3, F4, V>> {

  CallbackMetric4(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric4.CellKey<F1, F2, F3, F4>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric4.CellKey<F1, F2, F3, F4>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric4.CellKey<F1, F2, F3, F4>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
