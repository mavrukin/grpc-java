...
/**
 * A two-dimensional CallbackMetric.
 *
...
public class CallbackMetric2<F1, F2, V>
    extends CallbackMetric<V, CallbackMetric2<F1, F2, V>> {

  CallbackMetric2(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric2.CellKey<F1, F2>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric2.CellKey<F1, F2>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric2.CellKey<F1, F2>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
