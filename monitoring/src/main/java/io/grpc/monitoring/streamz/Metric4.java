...
/**
 * A four-dimensional Metric. This provides access to {@link StoredCell}s,
...
public class Metric4<F1, F2, F3, F4, V>
    extends StoredMetric<V, Metric4<F1, F2, F3, F4, V>> {

  /**
   * @see #createCellKey(
   *      Object, Object, Object, Object)
   */
  public static final class CellKey<F1, F2, F3, F4> extends FieldTuple {
    CellKey(F1 field1,
      F2 field2,
      F3 field3,
      F4 field4) {
   ...
   */
  public static
      <F1, F2, F3, F4> CellKey<F1, F2, F3, F4>
      createCellKey(
          F1 field1,
      F2 field2,
      F3 field3,
      F4 field4) {
    return new CellKey<F1, F2, F3, F4>(
        field1, field2, field3, field4);
  }

  Metric4(String name, ValueTypeTraits<V> traits, Metadata metadata,
   ...
   */
  public V get(CellKey<F1, F2, F3, F4> key) {
   ...
   */
  public void clear(CellKey<F1, F2, F3, F4> key) {
    super.clear(key);
  }
   ...
   */
  public void increment(CellKey<F1, F2, F3, F4> key) {
    super.increment(key);
  }
   ...
   */
  public void decrement(CellKey<F1, F2, F3, F4> key) {
    super.decrement(key);
  }
  ...
  public void incrementBy(
      CellKey<F1, F2, F3, F4> key, Number value) {
  ...
  @Override
  public Set<CellKey<F1, F2, F3, F4>> keySet() {
    return (Set<CellKey<F1, F2, F3, F4>>) super.keySet();
  }
}