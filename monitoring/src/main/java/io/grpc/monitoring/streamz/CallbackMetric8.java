...
/**
 * A eight-dimensional CallbackMetric.
 *
...
public class CallbackMetric8<F1, F2, F3, F4, F5, F6, F7, F8, V>
    extends CallbackMetric<V, CallbackMetric8<F1, F2, F3, F4, F5, F6, F7, F8, V>> {

  CallbackMetric8(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric8.CellKey<F1, F2, F3, F4, F5, F6, F7, F8>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric8.CellKey<F1, F2, F3, F4, F5, F6, F7, F8>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric8.CellKey<F1, F2, F3, F4, F5, F6, F7, F8>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
