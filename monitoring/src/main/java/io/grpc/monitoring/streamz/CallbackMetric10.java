...
/**
 * A ten-dimensional CallbackMetric.
 *
...
public class CallbackMetric10<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, V>
    extends CallbackMetric<V, CallbackMetric10<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, V>> {

  CallbackMetric10(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric10.CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric10.CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric10.CellKey<F1, F2, F3, F4, F5, F6, F7, F8, F9, F10>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
