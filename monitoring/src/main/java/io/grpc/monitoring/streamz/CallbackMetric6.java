...
/**
 * A six-dimensional CallbackMetric.
 *
...
public class CallbackMetric6<F1, F2, F3, F4, F5, F6, V>
    extends CallbackMetric<V, CallbackMetric6<F1, F2, F3, F4, F5, F6, V>> {

  CallbackMetric6(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric6.CellKey<F1, F2, F3, F4, F5, F6>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric6.CellKey<F1, F2, F3, F4, F5, F6>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric6.CellKey<F1, F2, F3, F4, F5, F6>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
