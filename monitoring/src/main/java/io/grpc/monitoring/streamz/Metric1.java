...
/**
 * A one-dimensional Metric. This provides access to {@link StoredCell}s,
...
public class Metric1<F1, V>
    extends StoredMetric<V, Metric1<F1, V>> {

  /**
   * @see #createCellKey(
   *      Object)
   */
  public static final class CellKey<F1> extends FieldTuple {
    CellKey(F1 field1) {
      super(field1);
    }
  }
  ...
  public static
      ...
      createCellKey(
          F1 field1) {
    return new CellKey<F1>(
        field1);
  }

  Metric1(String name, ValueTypeTraits<V> traits, Metadata metadata,
   ...
   */
  public void clear(CellKey<F1> key) {
    super.clear(key);
  }
   ...
   */
  public void increment(CellKey<F1> key) {
    super.increment(key);
  }
   ...
   */
  public void decrement(CellKey<F1> key) {
    super.decrement(key);
  }
  ...
  @Override
  public Set<CellKey<F1>> keySet() {
    return (Set<CellKey<F1>>) super.keySet();
  }
}