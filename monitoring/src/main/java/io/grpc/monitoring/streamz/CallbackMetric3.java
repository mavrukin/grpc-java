...
/**
 * A three-dimensional CallbackMetric.
 *
...
public class CallbackMetric3<F1, F2, F3, V>
    extends CallbackMetric<V, CallbackMetric3<F1, F2, F3, V>> {

  CallbackMetric3(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric3.CellKey<F1, F2, F3>, V)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric3.CellKey<F1, F2, F3>, V, long)
   */
  public void set(
      F1 field1,
      F2 field2,
  ...
  /**
   * @see #set(Metric3.CellKey<F1, F2, F3>, V, long, long)
   */
  public void set(
      F1 field1,
      F2 field2,
