...
/**
 * A one-dimensional CallbackMetric.
 *
...
public class CallbackMetric1<F1, V>
    extends CallbackMetric<V, CallbackMetric1<F1, V>> {

  CallbackMetric1(String name, ValueTypeTraits<V> traits, Metadata metadata,
  ...
  /**
   * @see #set(Metric1.CellKey<F1>, V, long)
   */
  public void set(
      F1 field1,
      V value,
  ...
  /**
   * @see #set(Metric1.CellKey<F1>, V, long, long)
   */
  public void set(
      F1 field1,
      V value,
