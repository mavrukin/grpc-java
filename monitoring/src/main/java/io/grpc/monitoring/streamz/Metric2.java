...
/**
 * A two-dimensional Metric. This provides access to {@link StoredCell}s,
...
public class Metric2<F1, F2, V>
    extends StoredMetric<V, Metric2<F1, F2, V>> {

  /**
   * @see #createCellKey(
   *      Object, Object)
   */
  public static final class CellKey<F1, F2> extends FieldTuple {
    CellKey(F1 field1,
      F2 field2) {
      super(field1, field2);
    }
  ...
  public static
      ...
      createCellKey(
          F1 field1,
      F2 field2) {
    return new CellKey<F1, F2>(
        field1, field2);
  }

  Metric2(String name, ValueTypeTraits<V> traits, Metadata metadata,
   ...
   */
  public V get(CellKey<F1, F2> key) {
   ...
   */
  public void clear(CellKey<F1, F2> key) {
    super.clear(key);
  }
   ...
   */
  public void increment(CellKey<F1, F2> key) {
    super.increment(key);
  }
   ...
   */
  public void decrement(CellKey<F1, F2> key) {
    super.decrement(key);
  }
  ...
  public void incrementBy(
      CellKey<F1, F2> key, Number value) {
  ...
  @Override
  public Set<CellKey<F1, F2>> keySet() {
    return (Set<CellKey<F1, F2>>) super.keySet();
  }
}